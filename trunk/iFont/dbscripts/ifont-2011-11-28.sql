...
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (1,0,1,422,0,'root.1','Root Asset','{\"core.login.site\":{\"6\":1,\"2\":1},\"core.login.admin\":{\"6\":1},\"core.login.offline\":{\"6\":1},\"core.admin\":{\"8\":1},\"core.manage\":{\"7\":1},\"core.create\":{\"6\":1,\"3\":1},\"core.delete\":{\"6\":1},\"core.edit\":{\"6\":1,\"4\":1},\"core.edit.state\":{\"6\":1,\"5\":1},\"core.edit.own\":{\"6\":1,\"3\":1}}');
...
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (8,1,17,26,1,'com_content','com_content','{\"core.admin\":{\"7\":1},\"core.manage\":{\"6\":1},\"core.create\":{\"3\":1},\"core.delete\":[],\"core.edit\":{\"4\":1},\"core.edit.state\":{\"5\":1},\"core.edit.own\":[]}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (9,1,27,28,1,'com_cpanel','com_cpanel','{}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (10,1,29,30,1,'com_installer','com_installer','{\"core.admin\":{\"7\":1},\"core.manage\":{\"7\":1},\"core.delete\":[],\"core.edit.state\":[]}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (11,1,31,32,1,'com_languages','com_languages','{\"core.admin\":{\"7\":1},\"core.manage\":[],\"core.create\":[],\"core.delete\":[],\"core.edit\":[],\"core.edit.state\":[]}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (12,1,33,34,1,'com_login','com_login','{}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (13,1,35,36,1,'com_mailto','com_mailto','{}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (14,1,37,38,1,'com_massmail','com_massmail','{}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (15,1,39,40,1,'com_media','com_media','{\"core.admin\":{\"7\":1},\"core.manage\":{\"6\":1},\"core.create\":{\"3\":1},\"core.delete\":{\"5\":1}}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (16,1,41,42,1,'com_menus','com_menus','{\"core.admin\":{\"7\":1},\"core.manage\":[],\"core.create\":[],\"core.delete\":[],\"core.edit\":[],\"core.edit.state\":[]}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (17,1,43,44,1,'com_messages','com_messages','{\"core.admin\":{\"7\":1},\"core.manage\":{\"7\":1}}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (18,1,45,46,1,'com_modules','com_modules','{\"core.admin\":{\"7\":1},\"core.manage\":[],\"core.create\":[],\"core.delete\":[],\"core.edit\":[],\"core.edit.state\":[]}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (19,1,47,50,1,'com_newsfeeds','com_newsfeeds','{\"core.admin\":{\"7\":1},\"core.manage\":{\"6\":1},\"core.create\":[],\"core.delete\":[],\"core.edit\":[],\"core.edit.state\":[],\"core.edit.own\":[]}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (20,1,51,52,1,'com_plugins','com_plugins','{\"core.admin\":{\"7\":1},\"core.manage\":[],\"core.edit\":[],\"core.edit.state\":[]}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (21,1,53,54,1,'com_redirect','com_redirect','{\"core.admin\":{\"7\":1},\"core.manage\":[]}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (22,1,55,56,1,'com_search','com_search','{\"core.admin\":{\"7\":1},\"core.manage\":{\"6\":1}}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (23,1,57,58,1,'com_templates','com_templates','{\"core.admin\":{\"7\":1},\"core.manage\":[],\"core.create\":[],\"core.delete\":[],\"core.edit\":[],\"core.edit.state\":[]}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (24,1,59,60,1,'com_users','com_users','{\"core.admin\":{\"7\":1},\"core.manage\":[],\"core.create\":[],\"core.delete\":[],\"core.edit\":[],\"core.edit.own\":{\"6\":1},\"core.edit.state\":[]}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (25,1,61,64,1,'com_weblinks','com_weblinks','{\"core.admin\":{\"7\":1},\"core.manage\":{\"6\":1},\"core.create\":{\"3\":1},\"core.delete\":[],\"core.edit\":{\"4\":1},\"core.edit.state\":{\"5\":1},\"core.edit.own\":[]}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (26,1,65,66,1,'com_wrapper','com_wrapper','{}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (27,8,18,25,2,'com_content.category.2','Uncategorised','{\"core.create\":[],\"core.delete\":[],\"core.edit\":[],\"core.edit.state\":[],\"core.edit.own\":[]}');
...
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (30,19,48,49,2,'com_newsfeeds.category.5','Uncategorised','{\"core.create\":[],\"core.delete\":[],\"core.edit\":[],\"core.edit.state\":[],\"core.edit.own\":[]}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (31,25,62,63,2,'com_weblinks.category.6','Uncategorised','{\"core.create\":[],\"core.delete\":[],\"core.edit\":[],\"core.edit.state\":[],\"core.edit.own\":[]}');
...
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (40,1,420,421,1,'com_shop','shop','{}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (41,27,21,22,3,'com_content.article.2','Gửi bán','{\"core.delete\":[],\"core.edit\":[],\"core.edit.state\":[]}');
insert  into `if_assets`(`id`,`parent_id`,`lft`,`rgt`,`level`,`name`,`title`,`rules`) values (42,27,23,24,3,'com_content.article.3','Đặt phông','{\"core.delete\":[],\"core.edit\":[],\"core.edit.state\":[]}');
...
insert  into `if_extensions`(`extension_id`,`name`,`type`,`element`,`folder`,`client_id`,`enabled`,`access`,`protected`,`manifest_cache`,`params`,`custom_data`,`system_data`,`checked_out`,`checked_out_time`,`ordering`,`state`) values (10019,'Shop Cart','module','mod_shop_cart','',0,1,0,0,'{\"legacy\":false,\"name\":\"Shop Cart\",\"type\":\"module\",\"creationDate\":\"July 2004\",\"author\":\"Duong Thien Duc\",\"copyright\":\"Copyright (C) 2005 - 2011 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"1.7.0\",\"description\":\"Shop Cart Module\",\"group\":\"\"}','','','',0,'0000-00-00 00:00:00',0,0);
...
insert  into `if_menu`(`id`,`menutype`,`title`,`alias`,`note`,`path`,`link`,`type`,`published`,`parent_id`,`level`,`component_id`,`ordering`,`checked_out`,`checked_out_time`,`browserNav`,`access`,`img`,`template_style_id`,`params`,`lft`,`rgt`,`home`,`language`,`client_id`) values (1,'','Menu_Item_Root','root','','','','',1,0,0,0,0,0,'0000-00-00 00:00:00',0,0,'',0,'',0,65,0,'*',0);
...
insert  into `if_menu`(`id`,`menutype`,`title`,`alias`,`note`,`path`,`link`,`type`,`published`,`parent_id`,`level`,`component_id`,`ordering`,`checked_out`,`checked_out_time`,`browserNav`,`access`,`img`,`template_style_id`,`params`,`lft`,`rgt`,`home`,`language`,`client_id`) values (102,'mainmenu','Đặt phông','font-place','','font-place','index.php?option=com_content&view=article&id=3','component',1,1,1,22,0,0,'0000-00-00 00:00:00',0,1,'',0,'{\"show_title\":\"\",\"link_titles\":\"\",\"show_intro\":\"\",\"show_category\":\"\",\"link_category\":\"\",\"show_parent_category\":\"\",\"link_parent_category\":\"\",\"show_author\":\"\",\"link_author\":\"\",\"show_create_date\":\"\",\"show_modify_date\":\"\",\"show_publish_date\":\"\",\"show_item_navigation\":\"\",\"show_vote\":\"\",\"show_icons\":\"\",\"show_print_icon\":\"\",\"show_email_icon\":\"\",\"show_hits\":\"\",\"show_noauth\":\"\",\"menu-anchor_title\":\"\",\"menu-anchor_css\":\"\",\"menu_image\":\"\",\"menu_text\":1,\"page_title\":\"\",\"show_page_heading\":0,\"page_heading\":\"\",\"pageclass_sfx\":\"\",\"menu-meta_description\":\"\",\"menu-meta_keywords\":\"\",\"robots\":\"\",\"secure\":0}',13,14,0,'*',0);
insert  into `if_menu`(`id`,`menutype`,`title`,`alias`,`note`,`path`,`link`,`type`,`published`,`parent_id`,`level`,`component_id`,`ordering`,`checked_out`,`checked_out_time`,`browserNav`,`access`,`img`,`template_style_id`,`params`,`lft`,`rgt`,`home`,`language`,`client_id`) values (103,'mainmenu','Gửi bán','sell-font','','sell-font','index.php?option=com_content&view=article&id=2','component',1,1,1,22,0,0,'0000-00-00 00:00:00',0,1,'',0,'{\"show_title\":\"\",\"link_titles\":\"\",\"show_intro\":\"\",\"show_category\":\"\",\"link_category\":\"\",\"show_parent_category\":\"\",\"link_parent_category\":\"\",\"show_author\":\"\",\"link_author\":\"\",\"show_create_date\":\"\",\"show_modify_date\":\"\",\"show_publish_date\":\"\",\"show_item_navigation\":\"\",\"show_vote\":\"\",\"show_icons\":\"\",\"show_print_icon\":\"\",\"show_email_icon\":\"\",\"show_hits\":\"\",\"show_noauth\":\"\",\"menu-anchor_title\":\"\",\"menu-anchor_css\":\"\",\"menu_image\":\"\",\"menu_text\":1,\"page_title\":\"\",\"show_page_heading\":0,\"page_heading\":\"\",\"pageclass_sfx\":\"\",\"menu-meta_description\":\"\",\"menu-meta_keywords\":\"\",\"robots\":\"\",\"secure\":0}',15,16,0,'*',0);
insert  into `if_menu`(`id`,`menutype`,`title`,`alias`,`note`,`path`,`link`,`type`,`published`,`parent_id`,`level`,`component_id`,`ordering`,`checked_out`,`checked_out_time`,`browserNav`,`access`,`img`,`template_style_id`,`params`,`lft`,`rgt`,`home`,`language`,`client_id`) values (104,'mainmenu','Web Embedding','2011-10-10-16-38-44','','2011-10-10-16-38-44','#','url',1,1,1,0,0,0,'0000-00-00 00:00:00',0,1,'',0,'{\"menu-anchor_title\":\"\",\"menu-anchor_css\":\"\",\"menu_image\":\"\",\"menu_text\":1}',17,18,0,'*',0);
insert  into `if_menu`(`id`,`menutype`,`title`,`alias`,`note`,`path`,`link`,`type`,`published`,`parent_id`,`level`,`component_id`,`ordering`,`checked_out`,`checked_out_time`,`browserNav`,`access`,`img`,`template_style_id`,`params`,`lft`,`rgt`,`home`,`language`,`client_id`) values (105,'mainmenu','Embedding','embedding','','embedding','#','url',-2,1,1,8,0,0,'0000-00-00 00:00:00',0,1,'',0,'{\"menu-anchor_title\":\"\",\"menu-anchor_css\":\"\",\"menu_image\":\"\",\"menu_text\":1}',19,20,0,'*',0);
insert  into `if_menu`(`id`,`menutype`,`title`,`alias`,`note`,`path`,`link`,`type`,`published`,`parent_id`,`level`,`component_id`,`ordering`,`checked_out`,`checked_out_time`,`browserNav`,`access`,`img`,`template_style_id`,`params`,`lft`,`rgt`,`home`,`language`,`client_id`) values (106,'mainmenu','Giới thiệu','gioi-thieu','','gioi-thieu','index.php?option=com_content&view=article&id=1','component',1,1,1,22,0,0,'0000-00-00 00:00:00',0,1,'',7,'{\"show_title\":\"\",\"link_titles\":\"\",\"show_intro\":\"\",\"show_category\":\"\",\"link_category\":\"\",\"show_parent_category\":\"\",\"link_parent_category\":\"\",\"show_author\":\"\",\"link_author\":\"\",\"show_create_date\":\"\",\"show_modify_date\":\"\",\"show_publish_date\":\"\",\"show_item_navigation\":\"\",\"show_vote\":\"\",\"show_icons\":\"\",\"show_print_icon\":\"\",\"show_email_icon\":\"\",\"show_hits\":\"\",\"show_noauth\":\"\",\"menu-anchor_title\":\"\",\"menu-anchor_css\":\"\",\"menu_image\":\"\",\"menu_text\":1,\"page_title\":\"\",\"show_page_heading\":1,\"page_heading\":\"M\\u1ee5c ti\\u00eau\",\"pageclass_sfx\":\"\",\"menu-meta_description\":\"\",\"menu-meta_keywords\":\"\",\"robots\":\"\",\"secure\":0}',21,22,0,'*',0);
...
insert  into `if_menu`(`id`,`menutype`,`title`,`alias`,`note`,`path`,`link`,`type`,`published`,`parent_id`,`level`,`component_id`,`ordering`,`checked_out`,`checked_out_time`,`browserNav`,`access`,`img`,`template_style_id`,`params`,`lft`,`rgt`,`home`,`language`,`client_id`) values (184,'hiddenmenu','Đăng ký','register','','register','index.php?option=com_users&view=registration','component',1,1,1,25,0,0,'0000-00-00 00:00:00',0,1,'',0,'{\"menu-anchor_title\":\"\",\"menu-anchor_css\":\"\",\"menu_image\":\"\",\"menu_text\":1,\"page_title\":\"\\u0110\\u0103ng k\\u00fd\",\"show_page_heading\":0,\"page_heading\":\"\",\"pageclass_sfx\":\"\",\"menu-meta_description\":\"\",\"menu-meta_keywords\":\"\",\"robots\":\"\",\"secure\":0}',53,54,0,'*',0);
insert  into `if_menu`(`id`,`menutype`,`title`,`alias`,`note`,`path`,`link`,`type`,`published`,`parent_id`,`level`,`component_id`,`ordering`,`checked_out`,`checked_out_time`,`browserNav`,`access`,`img`,`template_style_id`,`params`,`lft`,`rgt`,`home`,`language`,`client_id`) values (185,'hiddenmenu','Giỏ hàng','shop-cart','','shop-cart','index.php?option=com_shop&view=cart','component',1,1,1,10014,0,0,'0000-00-00 00:00:00',0,1,'',0,'{\"page_subheading\":\"\",\"menu-anchor_title\":\"\",\"menu-anchor_css\":\"\",\"menu_image\":\"\",\"menu_text\":1,\"page_title\":\"Gi\\u1ecf h\\u00e0ng\",\"show_page_heading\":1,\"page_heading\":\"\",\"pageclass_sfx\":\"\",\"menu-meta_description\":\"\",\"menu-meta_keywords\":\"\",\"robots\":\"\",\"secure\":0}',55,56,0,'*',0);
insert  into `if_menu`(`id`,`menutype`,`title`,`alias`,`note`,`path`,`link`,`type`,`published`,`parent_id`,`level`,`component_id`,`ordering`,`checked_out`,`checked_out_time`,`browserNav`,`access`,`img`,`template_style_id`,`params`,`lft`,`rgt`,`home`,`language`,`client_id`) values (186,'main','COM_SHOP_MENU_SHOP','comshopmenushop','','comshopmenushop','index.php?option=com_shop','component',0,1,1,10014,0,0,'0000-00-00 00:00:00',0,1,'class:contact',0,'',57,64,0,'',1);
insert  into `if_menu`(`id`,`menutype`,`title`,`alias`,`note`,`path`,`link`,`type`,`published`,`parent_id`,`level`,`component_id`,`ordering`,`checked_out`,`checked_out_time`,`browserNav`,`access`,`img`,`template_style_id`,`params`,`lft`,`rgt`,`home`,`language`,`client_id`) values (187,'main','COM_SHOP_SUBMENU_PACKAGES','comshopsubmenupackages','','comshopmenushop/comshopsubmenupackages','index.php?option=com_shop&view=packages','component',0,186,2,10014,0,0,'0000-00-00 00:00:00',0,1,'class:contact',0,'',58,59,0,'',1);
insert  into `if_menu`(`id`,`menutype`,`title`,`alias`,`note`,`path`,`link`,`type`,`published`,`parent_id`,`level`,`component_id`,`ordering`,`checked_out`,`checked_out_time`,`browserNav`,`access`,`img`,`template_style_id`,`params`,`lft`,`rgt`,`home`,`language`,`client_id`) values (188,'main','COM_SHOP_SUBMENU_FONTS','comshopsubmenufonts','','comshopmenushop/comshopsubmenufonts','index.php?option=com_shop&view=fonts','component',0,186,2,10014,0,0,'0000-00-00 00:00:00',0,1,'class:contact',0,'',60,61,0,'',1);
insert  into `if_menu`(`id`,`menutype`,`title`,`alias`,`note`,`path`,`link`,`type`,`published`,`parent_id`,`level`,`component_id`,`ordering`,`checked_out`,`checked_out_time`,`browserNav`,`access`,`img`,`template_style_id`,`params`,`lft`,`rgt`,`home`,`language`,`client_id`) values (189,'main','COM_SHOP_SUBMENU_TYPES','comshopsubmenutypes','','comshopmenushop/comshopsubmenutypes','index.php?option=com_shop&view=types','component',0,186,2,10014,0,0,'0000-00-00 00:00:00',0,1,'class:contact',0,'',62,63,0,'',1);
...
insert  into `if_modules`(`id`,`title`,`note`,`content`,`ordering`,`position`,`checked_out`,`checked_out_time`,`publish_up`,`publish_down`,`published`,`module`,`access`,`showtitle`,`params`,`client_id`,`language`) values (22,'Shop Cart','','',0,NULL,42,'2011-11-17 08:37:08','0000-00-00 00:00:00','0000-00-00 00:00:00',0,'mod_shop_cart',1,1,'',0,'*');
...
insert  into `if_session`(`session_id`,`client_id`,`guest`,`time`,`data`,`userid`,`username`,`usertype`) values ('4b96q75u97gkh8johm1nnkrur3',1,0,'1322466285','__default|a:8:{s:15:\"session.counter\";i:46;s:19:\"session.timer.start\";i:1322463646;s:18:\"session.timer.last\";i:1322466284;s:17:\"session.timer.now\";i:1322466285;s:22:\"session.client.browser\";s:107:\"Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/534.30 (KHTML, like Gecko) Chrome/12.0.742.91 Safari/534.30\";s:8:\"registry\";O:9:\"JRegistry\":1:{s:7:\"\0*\0data\";O:8:\"stdClass\":2:{s:11:\"application\";O:8:\"stdClass\":1:{s:4:\"lang\";s:0:\"\";}s:8:\"com_shop\";O:8:\"stdClass\":1:{s:4:\"edit\";O:8:\"stdClass\":1:{s:7:\"package\";O:8:\"stdClass\":2:{s:2:\"id\";a:1:{i:0;i:3;}s:4:\"data\";N;}}}}}s:4:\"user\";O:5:\"JUser\":23:{s:9:\"\0*\0isRoot\";b:1;s:2:\"id\";s:2:\"42\";s:4:\"name\";s:10:\"Super User\";s:8:\"username\";s:11:\"ifont_admin\";s:5:\"email\";s:23:\"duongthienduc@yahoo.com\";s:8:\"password\";s:65:\"8537efa817c26b08e7036e622f65bb0b:aawuHgEyjDGaNgMLCgMsREQdFFKpJ589\";s:14:\"password_clear\";s:0:\"\";s:8:\"usertype\";s:10:\"deprecated\";s:5:\"block\";s:1:\"0\";s:9:\"sendEmail\";s:1:\"1\";s:12:\"registerDate\";s:19:\"2011-08-29 14:48:39\";s:13:\"lastvisitDate\";s:19:\"2011-11-28 04:06:12\";s:10:\"activation\";s:0:\"\";s:6:\"params\";s:0:\"\";s:6:\"groups\";a:1:{s:11:\"Super Users\";s:1:\"8\";}s:5:\"guest\";i:0;s:10:\"\0*\0_params\";O:9:\"JRegistry\":1:{s:7:\"\0*\0data\";O:8:\"stdClass\":0:{}}s:14:\"\0*\0_authGroups\";a:2:{i:0;i:1;i:1;i:8;}s:14:\"\0*\0_authLevels\";a:4:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;}s:15:\"\0*\0_authActions\";N;s:12:\"\0*\0_errorMsg\";N;s:10:\"\0*\0_errors\";a:0:{}s:3:\"aid\";i:0;}s:13:\"session.token\";s:32:\"11d793dd4f2fac90af226f200b9731aa\";}',42,'ifont_admin','');
insert  into `if_session`(`session_id`,`client_id`,`guest`,`time`,`data`,`userid`,`username`,`usertype`) values ('l2td3muu0mk58q506hqo216027',0,1,'1322466625','__default|a:8:{s:15:\"session.counter\";i:96;s:19:\"session.timer.start\";i:1322463350;s:18:\"session.timer.last\";i:1322466624;s:17:\"session.timer.now\";i:1322466625;s:22:\"session.client.browser\";s:70:\"Mozilla/5.0 (Windows NT 6.1; WOW64; rv:8.0) Gecko/20100101 Firefox/8.0\";s:8:\"registry\";O:9:\"JRegistry\":1:{s:7:\"\0*\0data\";O:8:\"stdClass\":1:{s:8:\"com_shop\";O:8:\"stdClass\":1:{s:8:\"packages\";O:8:\"stdClass\":1:{s:6:\"filter\";O:8:\"stdClass\":1:{s:4:\"type\";s:1:\"3\";}}}}}s:4:\"user\";O:5:\"JUser\":23:{s:9:\"\0*\0isRoot\";N;s:2:\"id\";i:0;s:4:\"name\";N;s:8:\"username\";N;s:5:\"email\";N;s:8:\"password\";N;s:14:\"password_clear\";s:0:\"\";s:8:\"usertype\";N;s:5:\"block\";N;s:9:\"sendEmail\";i:0;s:12:\"registerDate\";N;s:13:\"lastvisitDate\";N;s:10:\"activation\";N;s:6:\"params\";N;s:6:\"groups\";a:0:{}s:5:\"guest\";i:1;s:10:\"\0*\0_params\";O:9:\"JRegistry\":1:{s:7:\"\0*\0data\";O:8:\"stdClass\":0:{}}s:14:\"\0*\0_authGroups\";N;s:14:\"\0*\0_authLevels\";a:2:{i:0;i:1;i:1;i:1;}s:15:\"\0*\0_authActions\";N;s:12:\"\0*\0_errorMsg\";N;s:10:\"\0*\0_errors\";a:0:{}s:3:\"aid\";i:0;}s:13:\"session.token\";s:32:\"aab4d3e8253d8bd27542daf5854c0e18\";}',0,'','');
...
insert  into `if_shop_font`(`font_id`,`name`,`alias`,`description`,`price`,`package_id`,`status`,`ordering`,`file_path`,`thumb`,`order_times`,`created`,`modified`,`created_by`,`created_by_alias`,`modified_by`) values (10,'Test Font 1','test-font-1','<p>asdasd</p>',5555,2,0,0,'images/fonts/HelveticaiDesignVn-UltLtEx.ttf','images/fonts/1.jpg',4,'2011-11-25 02:23:33','0000-00-00 00:00:00',42,'',0);
insert  into `if_shop_font`(`font_id`,`name`,`alias`,`description`,`price`,`package_id`,`status`,`ordering`,`file_path`,`thumb`,`order_times`,`created`,`modified`,`created_by`,`created_by_alias`,`modified_by`) values (11,'Test Font 3','test-font-3','<p>asdasd</p>',5555,2,0,0,'images/fonts/HelveticaiDesignVn-LtCnO.ttf','images/fonts/1.jpg',9,'2011-11-25 02:23:37','0000-00-00 00:00:00',42,'',0);
insert  into `if_shop_font`(`font_id`,`name`,`alias`,`description`,`price`,`package_id`,`status`,`ordering`,`file_path`,`thumb`,`order_times`,`created`,`modified`,`created_by`,`created_by_alias`,`modified_by`) values (12,'Helvetica Font 1','helvetica-font-1','<p>Helvetica Font 1</p>',1234,3,0,0,'images/fonts/HelveticaiDesign-BdCn.ttf','images/fonts/1.jpg',6,'2011-11-25 02:23:43','0000-00-00 00:00:00',0,'',NULL);
insert  into `if_shop_font`(`font_id`,`name`,`alias`,`description`,`price`,`package_id`,`status`,`ordering`,`file_path`,`thumb`,`order_times`,`created`,`modified`,`created_by`,`created_by_alias`,`modified_by`) values (13,'Helvetica Font 2','helvetica-font-2','<p>Helvetica Font 2</p>',12342,3,0,0,'images/fonts/HelveticaiDesignVn-BlkCnO.ttf','images/fonts/1.jpg',2,'2011-11-25 02:23:46','0000-00-00 00:00:00',0,'',NULL);
insert  into `if_shop_font`(`font_id`,`name`,`alias`,`description`,`price`,`package_id`,`status`,`ordering`,`file_path`,`thumb`,`order_times`,`created`,`modified`,`created_by`,`created_by_alias`,`modified_by`) values (14,'Test Font 2','test-font-2','<p>Test Font 2</p>',55552,2,0,0,'images/fonts/HelveticaiDesignVn-XBlkCnO.ttf','images/fonts/1.jpg',3,'2011-11-25 02:23:50','0000-00-00 00:00:00',0,'',NULL);
...
insert  into `if_shop_package`(`package_id`,`name`,`alias`,`description`,`price`,`status`,`thumb`,`is_vietnamese`,`is_mac`,`is_windows`,`order_times`,`created`,`modified`,`created_by`,`modified_by`) values (2,'Test Package','test-package','<p>asdasd</p>\r\n<p>asd</p>',100000,1,'images/fonts/1.jpg',0,1,1,15,'2011-11-15 16:35:36','0000-00-00 00:00:00',42,NULL);
insert  into `if_shop_package`(`package_id`,`name`,`alias`,`description`,`price`,`status`,`thumb`,`is_vietnamese`,`is_mac`,`is_windows`,`order_times`,`created`,`modified`,`created_by`,`modified_by`) values (3,'Helvetica','helvetica','<p>asdasd</p>\r\n<p>asdasdasd</p>\r\n<p>asd</p>',555555,1,'images/fonts/1.jpg',1,1,0,20,'2011-11-12 16:35:36','0000-00-00 00:00:00',42,NULL);
...
/*Data for the table `if_shop_package_type` */

insert  into `if_shop_package_type`(`id`,`package_id`,`type_id`) values (36,3,1);
insert  into `if_shop_package_type`(`id`,`package_id`,`type_id`) values (37,3,5);
insert  into `if_shop_package_type`(`id`,`package_id`,`type_id`) values (38,3,3);
insert  into `if_shop_package_type`(`id`,`package_id`,`type_id`) values (47,2,4);
insert  into `if_shop_package_type`(`id`,`package_id`,`type_id`) values (48,2,1);
insert  into `if_shop_package_type`(`id`,`package_id`,`type_id`) values (49,2,5);
insert  into `if_shop_package_type`(`id`,`package_id`,`type_id`) values (50,2,2);
...
CREATE TABLE `if_shop_type` (
  ...
  `ordering` int(3) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18446744073709551615 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC;

/*Data for the table `if_shop_type` */

insert  into `if_shop_type`(`id`,`title`,`description`,`ordering`) values (1,'Có chân','<p>Kiểu chữ có chân</p>',0);
insert  into `if_shop_type`(`id`,`title`,`description`,`ordering`) values (2,'Hiện đại','<p>Kiểu chữ hiện đại</p>',0);
insert  into `if_shop_type`(`id`,`title`,`description`,`ordering`) values (3,'Không chân','<p>Kiểu chữ không chân</p>',0);
insert  into `if_shop_type`(`id`,`title`,`description`,`ordering`) values (4,'Chuyển tiếp','<p>Kiểu chữ chuyển tiếp</p>',0);
insert  into `if_shop_type`(`id`,`title`,`description`,`ordering`) values (5,'Cổ điển','<p>Kiểu chữ cổ điển</p>',0);
...
insert  into `if_user_usergroup_map`(`user_id`,`group_id`) values (43,2);
insert  into `if_user_usergroup_map`(`user_id`,`group_id`) values (44,2);
insert  into `if_user_usergroup_map`(`user_id`,`group_id`) values (45,2);
insert  into `if_user_usergroup_map`(`user_id`,`group_id`) values (46,2);
insert  into `if_user_usergroup_map`(`user_id`,`group_id`) values (47,2);
insert  into `if_user_usergroup_map`(`user_id`,`group_id`) values (48,2);
...
insert  into `if_users`(`id`,`name`,`username`,`email`,`password`,`usertype`,`block`,`sendEmail`,`registerDate`,`lastvisitDate`,`activation`,`params`) values (42,'Super User','ifont_admin','duongthienduc@yahoo.com','8537efa817c26b08e7036e622f65bb0b:aawuHgEyjDGaNgMLCgMsREQdFFKpJ589','deprecated',0,1,'2011-08-29 14:48:39','2011-11-28 07:00:58','','');
insert  into `if_users`(`id`,`name`,`username`,`email`,`password`,`usertype`,`block`,`sendEmail`,`registerDate`,`lastvisitDate`,`activation`,`params`) values (46,'duc@yahoo.com','duc@yahoo.com','duc@yahoo.com','164ce9a69a2c91366771bfc5dbc0546a:mTFJrbhVNRhYJEbVuSeSSds5c4Xmk2Tw','',0,1,'2011-11-16 18:01:09','2011-11-25 10:40:47','','{}');
insert  into `if_users`(`id`,`name`,`username`,`email`,`password`,`usertype`,`block`,`sendEmail`,`registerDate`,`lastvisitDate`,`activation`,`params`) values (47,'duc1@yahoo.com','duc1@yahoo.com','duc1@yahoo.com','6e34a6844498814a069c95956568076b:qulMTOVskkN6W7OM6QIdWrCRZdZW7x8L','',1,0,'2011-11-20 08:46:45','0000-00-00 00:00:00','2413c69c16aebabf9b3f4781ff2184da','{}');
insert  into `if_users`(`id`,`name`,`username`,`email`,`password`,`usertype`,`block`,`sendEmail`,`registerDate`,`lastvisitDate`,`activation`,`params`) values (48,'duongthienduc@gmail.com','duongthienduc@gmail.com','duongthienduc@gmail.com','9c9d4f0ed21722611b66519e23c31fbe:3upGuMsrpVGcVRETm9N4gAYKc7KbhTOx','',0,0,'2011-11-20 08:47:24','2011-11-20 09:11:23','','{}');
